...
<template>
  <Transition name="slide-fade">
    <div v-if="show" class="sticky top-0  bg-white" style="z-index: 10;">
      <div class="border-b-1 border-gray-300">
        <div class="container mx-auto py-2 max-w-[1184px]  grid grid-cols-3 items-center">
          <div class="col-span-2 text-sm">
            <a href="#" class="flex items-center" @click.prevent>
              <svg viewBox="0 0 24 24" width="16px" height="16px" class="me-2">
                <path d="m16.6 5.65-6.4 6.4 6.4 6.3-1.4 1.4-7.8-7.7 7.8-7.8z" />
              </svg>
          ...
          <div class="col-span-1 flex items-center justify-end">
            <svg
              class="cursor-pointer me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
        ...
        <div class="container mx-auto py-3 space-y-6 max-w-[1184px]">
          <div class="grid grid-cols-4 items-center">
            <div class="col-span-1 flex gap-3 items-center">
              <p class="w-1/2 truncate text-sm font-semibold">
            ...
            <div class="col-span-1 flex items-center justify-end">
              <div class="grid grid-rows-2 items-center me-2">
                <div class="text-[1.4rem] font-bold text-gray-800 mb-0 h-5">
                  $200
                </div>
              ...
              <a
                ...
                @click.prevent="emit('goto', 'pricing')"
              >
